        ...
        <section className="py-16 px-4 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="bg-blue-900/10 rounded-xl p-6 border border-gray-800 hover:border-gray-700 transition-all group"
                >
            ...
            >
              ...
              <div className="bg-gradient-to-br from-blue-600/20 via-cyan-600/20 to-blue-600/20 rounded-2xl p-8 border border-blue-500/30">
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  {/* Right: Download */}
                  <div className="flex flex-col justify-center items-center bg-blue-900/10 rounded-xl p-8">
            ...
            <motion.div
              ...
              className="bg-blue-900/10 rounded-2xl p-8 border border-gray-800 mb-12"
            >
            ...
            >
              <div className="inline-block bg-blue-900/10 rounded-xl p-6 border border-gray-800">
