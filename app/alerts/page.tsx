              ...
              {filteredAlerts.map((alert, index) => (
                ...
                >
                  <Link href={`/alerts/${alert.slug}`}>
                    <div className={`bg-blue-500/5 border rounded-xl p-6 hover:bg-blue-500/10 transition-all cursor-pointer ${alert.isPinned ? 'border-yellow-500/30 bg-yellow-500/5' : 'border-blue-500/20'
                      }`}>
